...
export default function MobileNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-background border-t border-border p-3 flex justify-around">
      <Link href="/">
        <a className={`${location === '/' ? 'text-primary' : 'text-muted-foreground'} text-center flex flex-col items-center`}>
      ...
      <Link href="/profile">
        <a className={`${location === '/profile' ? 'text-primary' : 'text-muted-foreground'} text-center flex flex-col items-center`}>
